...
class CertificateParameters(BaseModel):
    ...
    REG_NO: str = Field(
        ..., description='Unique Registration Number', examples=['12PO0012']
    )
...
class TrcerCertificatePostRequest(BaseModel):
...
class TrcerCertificatePostResponse(BaseModel):
...
class TrcerCertificatePostResponse1(BaseModel):
...
class TrcerCertificatePostResponse2(BaseModel):
...
class TrcerCertificatePostResponse3(BaseModel):
...
class TrcerCertificatePostResponse4(BaseModel):
...
class TrcerCertificatePostResponse5(BaseModel):
...
class TrcerCertificatePostResponse6(BaseModel):
